...
public class User {
    ...
    public static com.Services.User getUserSender(JSONObject from){
        Integer id = from.getInt("id");
        String username = from.getString("username");
        return new com.Services.User(id,username);
    }
    public static com.Services.User getUserForwardFrom(JSONObject forwardFrom){
